			...
			<div class="main-content">
				...
				<div class="row">
					<div class="col-sm-3">
						<ul class="aside-menu">
							@foreach($loai as $l)
							<li><a href="{{route('loaisanpham',$l->id)}}">{{$l->name}}</a>
							</li>
							@endforeach
						</ul>
					</div>
								...
								<div class="col-sm-4" style="padding-top: 10px">
									<div class="single-item">
										...
										<div class="single-item-header">
											<a href="{{route('chitietsanpham',$sp->id)}}"><img src="source/image/product/{{$sp->image}}" height="250px" alt=""></a>
										</div>
										...
										<div class="single-item-caption">
											<a class="add-to-cart pull-left" href="{{route('dathang')}}"><i class="fa fa-shopping-cart"></i></a>
							...
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="single-item">
										...
										@endif
										<div class="single-item-header">
											<a href="{{route('chitietsanpham',$sp_k->id)}}"><img src="source/image/product/{{$sp_k->image}}" height="250px" alt=""></a>
										</div>
										<div class="single-item-body">
